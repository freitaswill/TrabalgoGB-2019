...
void InputTexto::desenharSenha()
{
	...
	txtSenha.desenhar(gJanela.getLargura() / 2, gJanela.getAltura() / 2 + 50);
	...
	int yCursor = (gJanela.getAltura() / 2 + 50) - altCursor / 2;
...
{
	//4) Mostrar o texto na tela
	txt.desenhar(gJanela.getLargura() / 2, gJanela.getAltura() / 2 - 50);
